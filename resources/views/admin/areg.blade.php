...
<div class="alert alert-danger">
  ...
  @endif
			<form class="contact100-form validate-form" method="post" action="{{URL::to('/store')}}">
				{{csrf_field()}}
				...
				<div class="wrap-input100 validate-input" >
					...
					<input class="input100" type="text" name="admin_name" placeholder="Name" value="{{old('admin_name')}}">
