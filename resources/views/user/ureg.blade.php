...
<div class="alert alert-danger">
  ...
  @endif
			<form class="contact100-form validate-form" method="post" action="{{URL::to('/storeu')}}">
				{{csrf_field()}}
				...
				<div class="wrap-input100 validate-input" >
					...
					<input class="input100" type="text" name="user_name" placeholder="Name" value="{{old('user_name')}}">
				...
				<div class="wrap-input100 validate-input" >
					...
					<input class="input100" type="text" name="user_email" placeholder="Email" value="{{old('user_email')}}" >
					
				</div>

				<div>
					<span>{{$errors->first('nid')}}</span>
				</div>

				<div class="wrap-input100 validate-input" >
					
					<input class="input100" type="number" name="nid" placeholder="NID number" value="{{old('nid')}}">
...
<div class="wrap-input100 validate-input" >
					...
					<input class="input100" type="hidden" name="approval" value="Not approved">
